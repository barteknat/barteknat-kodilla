...
public class ExtraFoodShopFood2Door implements Food2Door {

    private final String name;
    private static Map<Product, Quantity> products;

    public ExtraFoodShopFood2Door(String name) {
        this.name = name;
    ...
    public void setProducts() {
        products.put(new Product("product1"), new Quantity(1000, "kg"));
        products.put(new Product("product2"), new Quantity(150, "kg"));
    }
    ...
    public boolean equals(Object o) {
        ...
        ExtraFoodShopFood2Door that = (ExtraFoodShopFood2Door) o;
