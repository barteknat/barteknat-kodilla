...
public class GlutenFreeShopFood2Door implements Food2Door {

    private final String name;
    private static Map<Product, Quantity> products;

    public GlutenFreeShopFood2Door(String name) {
        this.name = name;
    ...
    public void setProducts() {
        products.put(new Product("product3"), new Quantity(1500, "kg"));
        products.put(new Product("product4"), new Quantity(850, "kg"));
    }
    ...
    public boolean equals(Object o) {
        ...
        GlutenFreeShopFood2Door that = (GlutenFreeShopFood2Door) o;
